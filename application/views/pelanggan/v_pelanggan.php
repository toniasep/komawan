...
<div class="content-wrapper">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-2">
				<a href="<?=base_url().'pelanggan/tambah'?>" class="float-right d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-3"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data</a>		
			</div>
		</div>
		<div class="row">
			<div class="col-xl-12">
